...
void main() {
  testWidgets('SearchPage builds grid with offers and without overflow', (
    tester,
  ) async {
    // Ensure mock env
    ...
    await tester.pumpWidget(
      ProviderScope(overrides: overrides, child: const ComprasEcApp()),
    );
    ...
    if (offers.isNotEmpty) {
      expect(find.text(offers.first.title), findsWidgets);
    }
